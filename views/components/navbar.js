...
const createNavbarClient = () => {
 ...
 <div class="flex flex-row justify-end text-right px-4 md:px-0 gap-4">
   <button  id="user-menu"  class="flex items-center hover:text-orange-500"><a href="/login">
       <!-- Inicio sesion -->
      ...
      <!-- navbar responsive -->
       ...
       <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 hover:text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!--navbar Desktop  -->
         <div>
           <ul class="hidden md:flex flex-row gap-4 text-xs font-semibold">
             <li class="hover:text-orange-500 flex flex-row gap-1"><a href="/comprar">COMPRAR </a>
</li>
             <li class="hover:text-orange-500"><a href="/eventos">EVENTOS</a></li>
             <li class="hover:text-orange-500"><a href="/sobre-nosotros">SOBRE NOSOTROS</a></li>
             <li class="hover:text-orange-500"><a href="/contacto">CONTACTO</a></li>
...
createNavbarUser();
console.log(userExist, userExist.rol);
}
};
